...
```
cd existing_repo
git remote add origin https://gitlab.com/henkev/edaf60-2023-computer-group-46.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/henkev/edaf60-2023-computer-group-46/-/settings/integrations)
